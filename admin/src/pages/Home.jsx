    ...
    <div className='w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] relative'>
      ...
      <div className='w-[70vw] h-[100vh] absolute left-[25%] flex items-start justify-start flex-col gap-[40px] py-[100px]'>
        ...
        <div className='flex items-center justify-start gap-[50px] flex-col md:flex-row'>
          <div className='text-[#dcfafd] w-[400px] max-w-[90%] h-[200px] bg-[#0000002e] flex items-center justify-center flex-col gap-[20px] rounded-lg shadow-sm dhadow-black backdrop-blur-lg md:text-[25px] text-[20px] border-[1px] border-[#969595]'>Total No. of Proucts : <span className='px-[20px] py-[10px] bg-[#030e11] rounded-lg flex-items-center justify-center border-[1px] border-[#969595]'>{totalProduct}</span></div>
          <div className='text-[#dcfafd] w-[400px] max-w-[90%] h-[200px] bg-[#0000002e] flex items-center justify-center flex-col gap-[20px] rounded-lg md:text-[25px] text-[20px] border-[1px] border-[#969595]'>Total No. of Orders: <span className='px-[20px] py-[10px] bg-[#030e11] rounded-lg flex-items-center justify-center border-[1px] border-[#969595]'>{totalOrders}</span></div>
        </div>
      </div>
    </div>
  )
