    ...
    <div className='w-[100%] md:h-[36vh] h-[21vh] mb-[77px] md:mb-[0px]'>
      <div className='w-[100%] md:h-[30vh] h-[15vh] md:mb-[0px] bg-[#dbfcfcec] flex items-center justify-center md:px-[50px] px-[5px]'>
        <div className='md:w-[30%] w-[35%] h-[100%] flex items-start justify-center flex-col gap-[5px]'>
            ...
            <p className='text-[15px] text-[#1e2223] hidden md:block'>OneCart is your all-in-one online shopping destination, offering top-quality products, unbeatable deals, and fast delivery-all backend by trusted service designed to make your life easier every day.</p>
        ...
        <div className='md:w-[25%] w-[30%] h-[100%] flex items-center justify-center flex-col text-center'>
                ...
                <ul>
                    <li className='text-[15px] text-[#1e2223] hiden md:block'>Home</li>
                    <li className='text-[15px] text-[#1e2223] hiden md:block'>About Us</li>
                    <li className='text-[15px] text-[#1e2223] hiden md:block'>Delivery</li>
                    <li className='text-[15px] text-[#1e2223] hiden md:block'>Privacy Policy</li>
            ...
            <div className='md:w-[25%] w-[40%] h-[100%] flex items-center justify-center flex-col text-center'>
                ...
                <ul>
                    <li className='text-[15px] text-[#1e2223] hiden md:block'>+91-9876543210</li>
                    <li className='text-[15px] text-[#1e2223] hiden md:block'>contact@onecart.com</li>
                    <li className='text-[15px] text-[#1e2223] hiden md:block'>+1-123-456-7890</li>
                    <li className='text-[15px] text-[#1e2223] hiden md:block'>admin@onecart.com</li>
